...
function main() {
  ...
  add(levels.length === 44 ? { ok: true, id: "level-count" } : fail("level-count", String(levels.length)));
  ...
  add(exercises === 703 ? { ok: true, id: "exercise-count" } : fail("exercise-count", String(exercises)));
