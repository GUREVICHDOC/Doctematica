...
function main() {
  ...
  add(levels.length === 39 ? { ok: true, id: "level-count" } : fail("level-count", String(levels.length)));
  ...
  add(exercises === 647 ? { ok: true, id: "exercise-count" } : fail("exercise-count", String(exercises)));
