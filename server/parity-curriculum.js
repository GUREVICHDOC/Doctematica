...
function main() {
  ...
  add(levels.length === 40 ? { ok: true, id: "level-count" } : fail("level-count", String(levels.length)));
  ...
  add(exercises === 650 ? { ok: true, id: "exercise-count" } : fail("exercise-count", String(exercises)));
