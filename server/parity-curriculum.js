...
function main() {
  ...
  add(levels.length === 41 ? { ok: true, id: "level-count" } : fail("level-count", String(levels.length)));
  ...
  add(exercises === 666 ? { ok: true, id: "exercise-count" } : fail("exercise-count", String(exercises)));
