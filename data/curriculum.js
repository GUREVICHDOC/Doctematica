  ...
  levels: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { n: 30, start: "-(3/4)x = 18" },
        { n: 31, start: "(1/5)x = 0" },
        { n: 32, start: "2 1/4 x = -9" },
        { n: 33, start: "-3 1/3 x = -10" },
      ],
    },
    {
      id: "level-03",
      ...
      exercises: [
        ...
        { n: 47, start: "-20x - 5 = 5" },
        { n: 48, start: "6 - 4x = 5" },
        { n: 49, start: "3.5x + 7 = 21" },
        { n: 50, start: "0.8x - 1 = 7" },
        { n: 51, start: "(1/2)x + 4 = 6" },
        { n: 52, start: "(1/6)x - 6 = 6" },
        { n: 53, start: "1 1/2 x - 4 = -10" },
        { n: 54, start: "-2 3/4 x + 10 = 32" },
      ],
    },
    {
      id: "level-04",
      ...
      exercises: [
        { n: 55, start: "7x + 3x = 50" },
        { n: 56, start: "9x - 5x = 28" },
        { n: 57, start: "9x + 6x = 55 - 10" },
        { n: 58, start: "x + x = 13 - 7" },
        { n: 59, start: "2x - x = 3 + 8" },
        { n: 60, start: "2x - 3x = -5 + 11" },
        { n: 61, start: "7x = 4x + 12" },
        { n: 62, start: "10x = -2x + 24" },
        { n: 63, start: "10x = 2x" },
        { n: 64, start: "7x + 40 = 58 - 2x" },
        { n: 65, start: "29 + 11x + 7 = 15x" },
        { n: 66, start: "3x - 15 = 25 - 5x" },
        { n: 67, start: "15 + 3x - 45 = -2x" },
        { n: 68, start: "7x - 3 = x + 21" },
        { n: 69, start: "4x + 9 = 11x + 44" },
        { n: 70, start: "6x + 9 = 13x + 9" },
        { n: 71, start: "-7x - 1 = 6x - 27" },
        { n: 72, start: "1 - x = x - 1" },
        { n: 73, start: "6.4 + 2.5x + 2.6 = -3.5x" },
        { n: 74, start: "3 1/3 x - 2 1/6 = x + 2 1/2" },
      ],
    },
    {
      id: "level-05",
      ...
      exercises: [
        { n: 75, start: "2(x+6)=20" },
        { n: 76, start: "7(x+2)+8=43" },
        { n: 77, start: "12+5(x+4)=22" },
        { n: 78, start: "-4+8(3+x)-52=0" },
        { n: 79, start: "3(x-4)+25=10" },
        { n: 80, start: "5+2(x-7)=7" },
        { n: 81, start: "-6+4(2-x)+2=0" },
        { n: 82, start: "-2(x+4)+15=11" },
        { n: 83, start: "3(2x+4)=-10+40" },
        { n: 84, start: "4(5x+1)-4=-80" },
        { n: 85, start: "4+9(5-2x)-31=0" },
        { n: 86, start: "9x-5(x+2)=18" },
        { n: 87, start: "8x-3(x-4)=32" },
        { n: 88, start: "7(x+4)=3(6-x)" },
        { n: 89, start: "8(x+3)=3(x+2)+43" },
        { n: 90, start: "6(x+2)-3(x+1)=24" },
        { n: 91, start: "7(x+3)-5(x-4)=49" },
        { n: 92, start: "11(x+6)-76=4(x+1)" },
        { n: 93, start: "3(x+4)=44+8(x-4)" },
        { n: 94, start: "8(3x-2)-5(x+1)=-40" },
        { n: 95, start: "6(x-3)=18-2(x+6)" },
        { n: 96, start: "9(2x-7)=17-4(x-2)" },
        { n: 97, start: "4(5x-7)-12-3(2x-4)=0" },
        { n: 98, start: "7(2x+2)-8(x-2)=48+3(x-3)" },
        { n: 99, start: "40-7(x+8)=3(x+6)-4(x+10)" },
        { n: 100, start: "12+6(x-4)-7(x+2)-4(x+6)=0" },
        { n: 101, start: "7(x-4)-8(x-7)=69-5(x+8)" },
        { n: 102, start: "7(2x-3)-5(x-4)=35-3(2x-8)" },
        { n: 103, start: "7(5x+4)-3(5x-8)=63-5(4x+7)" },
        { n: 104, start: "8(x+4)-3(x+6)=6(x-7)-5(x-3)+33" },
      ],
    },
    {
      id: "level-06",
      ...
      exercises: [
        ...
        { n: 5, start: "-(2/5)x=10" },
        { n: 6, start: "x/3+x/4=7" },
        { n: 7, start: "x/2+x/5=-14" },
        { n: 8, start: "x/3-x/5=6" },
        { n: 9, start: "x/2+x/4=9" },
        { n: 10, start: "x/5-x/10=0" },
        { n: 11, start: "3x-x/4+11=0" },
        { n: 12, start: "x/2+x/3=x/6" },
        { n: 13, start: "x/6-x/12+x/4=8" },
        { n: 14, start: "2x/3+3x/2=13" },
        { n: 15, start: "5x/4-4x/3=-1" },
        { n: 16, start: "3x/4+2=x/8+7" },
        { n: 17, start: "2x/3-5x/18=x/6-4" },
        { n: 18, start: "7x/24+5/6=11/8-x/4" },
        { n: 19, start: "x/20-3x/4+4x/5=1/3" },
        { n: 20, start: "(1/3)x+(3/4)x-(5/6)x=6" },
        { n: 21, start: "5x/12-7x/15=30-11x/20" },
      ],
    },
    {
      id: "level-07",
      ...
      instruction: "פתרו את המשוואות הבאות (מצאו את x):",
      exercises: [
        { n: 22, start: "(x-7)/6=1/2" },
        { n: 23, start: "(3+x)/4=x/3" },
        { n: 24, start: "(x+6)/4=5" },
        { n: 25, start: "(5-3x)/7=-1" },
        { n: 26, start: "(3x-8)/5+7=3" },
        { n: 27, start: "(x+3)/5=(x+1)/4" },
        { n: 28, start: "(8x-3)/9=(7x-2)/8" },
        { n: 29, start: "(x-6)/8+(x+3)/3=3" },
        { n: 30, start: "(3x+5)/4-(x+5)/5=3" },
        { n: 31, start: "8x/5=(5x-1)/6+4" },
        { n: 32, start: "(2x+1)/4-2x=(x-2)/3" },
        { n: 33, start: "(3x+8)/2-4x=(x-5)/3" },
        { n: 34, start: "2x+(x-3)/8=(x+3)/6+5" },
        { n: 35, start: "3x-(x-8)/10=(7x+4)/15+20" },
        { n: 36, start: "(4x-3)/6+6x=(8x+3)/9+7/2" },
        { n: 37, start: "(3x-2)/8-(2+3x)/6+1/3=0" },
        { n: 38, start: "3x+18-(x-3)/4=(x+5)/7-x" },
        { n: 39, start: "3+(x-7)/4+(5-4x)/5=9-x" },
        { n: 40, start: "2-(2x-1)/3+(1-3x)/7=7-2x" },
        { n: 41, start: "(4x-3)/6+(12x-7)/2=(8x+3)/9" },
      ],
    },
    {
      id: "level-08",
      ...
      exercises: [
        ...
        { n: 5, start: "-4/9=8/x" },
        { n: 6, start: "5/x+3/x=2" },
        { n: 7, start: "4/x+2/5=6/x" },
        { n: 8, start: "5/x+1/3=4/x" },
        { n: 9, start: "3/x+4/3=8/x+1/2" },
        { n: 10, start: "2/x+5/8=3/x+3/4" },
        { n: 11, start: "4/x-5/2=5/6-1/x" },
        { n: 12, start: "5/x+4/5-1/x=4/6" },
      ],
    },
    {
      id: "level-09",
      ...
      exercises: [
        ...
        { n: 4, start: "(x+8)/(x-2)=-1" },
        { n: 5, start: "6/(x+3)=1/2" },
        { n: 6, start: "4/(3x+2)-2/3=0" },
        { n: 7, start: "(6-x)/(x+2)=3/5" },
        { n: 8, start: "(3x-5)/(6-4x)=-2/3" },
        { n: 9, start: "4/x=3/(x-2)" },
        { n: 10, start: "1/(x+1)=7/(x-5)" },
        { n: 11, start: "3/(x-2)-7/(4-x)=0" },
        { n: 12, start: "2/(x-2)+2/5=4/(x-2)" },
        { n: 13, start: "3/(4-x)-1/3=2x/(4-x)" },
        { n: 14, start: "6/(5(x+4))=2/5" },
        { n: 15, start: "8/(4(x-1))=1/3" },
        { n: 16, start: "4/(x+2)+1=x/(3(x+2))" },
        { n: 17, start: "x/(x-1)-3=5/(2(x-1))" },
        { n: 18, start: "5/(4(x+3))=2/(x+3)-3/4" },
        { n: 19, start: "x/(1-x)-8/(2(1-x))-1/5=0" },
      ],
    },
    {
      id: "quad-formula",
      ...
      exercises: [
        { n: 1, start: "2x^2+9x+9=0" },
        { n: 2, start: "x^2+8x+12=0" },
        { n: 3, start: "x^2+10x+16=0" },
        { n: 4, start: "x^2+4x-12=0" },
        { n: 5, start: "5x^2+11x+6=0" },
        { n: 6, start: "x^2+2x-15=0" },
        { n: 7, start: "x^2-7x+10=0" },
        { n: 8, start: "5x^2+6x-8=0" },
        { n: 9, start: "8x^2+3x-5=0" },
        { n: 10, start: "10x^2-13x+4=0" },
        { n: 11, start: "x^2-12x+32=0" },
        { n: 12, start: "3x^2-11x+6=0" },
        { n: 13, start: "6x^2-5x-4=0" },
        { n: 14, start: "x^2-4x-12=0" },
        { n: 15, start: "x^2-6x-40=0" },
        { n: 16, start: "-6x^2+13x+8=0" },
        { n: 17, start: "5x^2-x-4=0" },
        { n: 18, start: "-x^2+9x-18=0" },
        { n: 20, start: "x^2+4x+4=0" },
        { n: 21, start: "x^2-6x+9=0" },
        { n: 22, start: "x^2+8x+17=0" },
        { n: 23, start: "25x^2+30x+9=0" },
        { n: 24, start: "9x^2-12x+4=0" },
        { n: 25, start: "-x^2-8x-16=0" },
        { n: 26, start: "-5x^2+x-3=0" },
        { n: 27, start: "4x^2-4x+1=0" },
        { n: 28, start: "x^2-x+1=0" },
      ],
    },
    {
      id: "quad-sqrt",
      ...
      exercises: [
        { n: 30, start: "x^2=4" },
        { n: 31, start: "x^2=16" },
        { n: 32, start: "x^2-100=0" },
        { n: 33, start: "x^2-1=0" },
        { n: 34, start: "x^2-0.49=0" },
        { n: 35, start: "x^2-1/4=0" },
        { n: 36, start: "x^2-9/16=0" },
        { n: 37, start: "x^2+81=0" },
        { n: 38, start: "x^2=0" },
        { n: 39, start: "-x^2+36=0" },
        { n: 40, start: "3x^2-3=0" },
        { n: 41, start: "5x^2-80=0" },
        { n: 42, start: "4x^2-100=0" },
        { n: 43, start: "8x^2+8=0" },
        { n: 44, start: "4x^2-9=0" },
      ],
    },
    {
      ...
      exercises: [
        { n: 45, start: "x^2-5x=0" },
        { n: 46, start: "x^2-6x=0" },
        { n: 47, start: "x^2-20x=0" },
        { n: 48, start: "x^2+7x=0" },
        { n: 49, start: "x^2+4x=0" },
        { n: 50, start: "x^2+10x=0" },
        { n: 51, start: "x^2-(1/2)x=0" },
        { n: 52, start: "-x^2+8x=0" },
        { n: 53, start: "-x^2-12x=0" },
        { n: 54, start: "5x^2+10x=0" },
        { n: 55, start: "9x^2+9x=0" },
        { n: 56, start: "6x^2-18x=0" },
        { n: 57, start: "2x^2-7x=0" },
        { n: 58, start: "3x^2-2x=0" },
        { n: 59, start: "5x^2+12x=0" },
      ],
    },
    {
      id: "quad-mixed",
      ...
      exercises: [
        { n: 1, start: "6+7x=-x^2" },
        { n: 2, start: "x^2-8x+24=9" },
        { n: 3, start: "x^2-x=-x^2+10" },
        { n: 4, start: "5x^2+20=4x^2+84" },
        { n: 5, start: "7x^2-15=3x^2+49" },
        { n: 6, start: "5x^2-3x=x^2-2x" },
        { n: 7, start: "4x^2+3x+28=3x^2+7x+28" },
        { n: 8, start: "20=x^2-2x+21" },
        { n: 9, start: "-4x^2+5x-4-4x+7x^2=0" },
        { n: 10, start: "6x^2-4x-26+10x=5x^2-26" },
        { n: 11, start: "3x^2-15x-14=7x^2-20x-23" },
        { n: 12, start: "-2x^2+37=8x^2-53" },
        { n: 13, start: "2x^2+8x+28-3x^2=14x+33" },
        { n: 14, start: "5x^2+8x-1=8x^2-5x-1" },
        { n: 15, start: "4x^2+20=2x^2+7" },
        { n: 16, start: "-12+9x-x^2=2x^2-3x" },
      ],
    },
    {
      id: "quad-mixed-2",
      ...
      exercises: [
        { n: 1, start: "x(x-6)=7" },
        { n: 2, start: "(x-5)x=-4" },
        { n: 3, start: "x(x+8)=x^2+24" },
        { n: 4, start: "x(x+2)=2x+9" },
        { n: 5, start: "4x+2(x+4)=x(x+4)" },
        { n: 6, start: "x(2x-3)=2x^2-18" },
        { n: 7, start: "x(2x-3)=-3(x-6)" },
        { n: 8, start: "(x-5)x=2x(x+3)" },
        { n: 9, start: "x(x-5)=x^2-3x" },
        { n: 10, start: "3x(x+2)=8(x+1)" },
        { n: 11, start: "15-5(x+3)-x^2=0" },
        { n: 12, start: "x(x-3)-2x=x^2+10" },
        { n: 13, start: "9-8(3-x)=x^2" },
        { n: 14, start: "34-3(10-x)=x^2" },
        { n: 15, start: "1-x(x+4)-3=-x^2" },
        { n: 16, start: "2x(x+3)-(x+3)=0" },
        { n: 17, start: "2x(3x-4)=10-(3-x)x" },
        { n: 18, start: "x(x-1)-(x+1)=x(x+3)" },
        { n: 19, start: "3x(x-1)-(x-8)-(3x-2)5x=8" },
        { n: 20, start: "2x-3(5-x)x=0" },
      ],
    },
    {
      id: "quad-mixed-3",
      ...
      exercises: [
        { n: 1, start: "(x+4)(x+7)=70" },
        { n: 2, start: "(x-5)(x+2)=0" },
        { n: 3, start: "(2x-5)(x+6)=9" },
        { n: 4, start: "(x-3)(x-7)=21+4x" },
        { n: 5, start: "(2-x)(x+1)=x-14" },
        { n: 6, start: "4x-3x^2=(x+1)(x-5)" },
        { n: 7, start: "(x-2)(x+3)=2x^2-4x" },
        { n: 8, start: "12x^2=(4x+2)(3x-4)+8" },
        { n: 9, start: "(x+4)(2x-1)=1-(3x-7)" },
        { n: 10, start: "(x+8)(x-2)=53+(x-5)(x-3)" },
      ],
    },
    {
      id: "quad-mixed-4",
      ...
      exercises: [
        { n: 1, start: "4(x+2)(x+3)-6x=12" },
        { n: 2, start: "2(x-1)(x+2)=5x^2-6x" },
        { n: 3, start: "3(x-2)(5-x)=2-(4x+10)" },
        { n: 4, start: "-5(x+4)(3x-7)=-(x+4)10" },
        { n: 5, start: "-2(1-x)(x-3)-(x+11)=0" },
        { n: 6, start: "6-(2-x)(3+x)=x^2-x" },
        { n: 7, start: "7(2x-1)(x-4)-3(3x-1)(x-4)=21" },
        { n: 8, start: "(2x+3)(x+5)-(x-2)(x+6)=27" },
        { n: 9, start: "(x+2)(x+4)-(2x+4)(x-5)=64" },
        { n: 10, start: "(x-4)(x-4)-(4x+5)(3x-10)=17x-110" },
      ],
    },
    {
      id: "quad-mixed-5",
      ...
      exercises: [
        { n: 1, start: "(x-4)^2+3x=12" },
        { n: 2, start: "(x+6)^2=4" },
        { n: 3, start: "(x-3)^2=x^2+6" },
        { n: 4, start: "(x-8)^2=x^2" },
        { n: 5, start: "(x+1)^2=1-x^2" },
        { n: 6, start: "(x-5)^2=x^2-5" },
        { n: 7, start: "(x-5)^2=x(x+15)" },
        { n: 8, start: "(x+4)^2=x(x-8)" },
        { n: 9, start: "(x-6)^2-x(x-8)=0" },
        { n: 10, start: "(x-3)^2=x(5-x)" },
        { n: 11, start: "(x-2)^2-x(x-2)=0" },
        { n: 12, start: "(x-10)^2-x(x+5)=0" },
        { n: 13, start: "(5x-2)^2+10x=4" },
        { n: 14, start: "(x+1)^2-(3+x)x=0" },
        { n: 15, start: "(3x-1)^2-(x+1)2=0" },
        { n: 16, start: "(2x+3)^2-12x-25=0" },
        { n: 17, start: "(2x+4)^2-(4x^2+x)=6" },
        { n: 18, start: "(2x-3)^2-(6+4x)x=0" },
      ],
    },
    {
      id: "quad-mixed-6",
      ...
      exercises: [
        { n: 1, start: "x^2/2=8" },
        { n: 2, start: "x^2/3=4x" },
        { n: 3, start: "(x^2+6x+9)/2=2" },
        { n: 4, start: "(x+4)(x-2)/4=10" },
        { n: 5, start: "(x+3)^2/2=8" },
        { n: 6, start: "(x-7)^2/8=1/2" },
        { n: 7, start: "2x+(x^2-3)/2=1" },
        { n: 8, start: "6x+(x-1)(x-6)/4=6" },
        { n: 9, start: "6x+(3x+1)^2/4=10" },
        { n: 10, start: "8-(x+4)(x-8)/3=-2x" },
        { n: 11, start: "6-(x+2)^2/4=2" },
        { n: 12, start: "x-(x-4)^2/2=4" },
        { n: 13, start: "2(x-4)-(x-2)^2/3=-1" },
        { n: 14, start: "3(1-4x)-(2x-1)^2/2=7" },
        { n: 15, start: "2(12+2x)-(3x-2)^2/5=20" },
        { n: 16, start: "x(x-2)-(2x-3)^2/4-6=0" },
        { n: 17, start: "(x-6)^2/2-(2x-4)^2/4=-2" },
        { n: 18, start: "(3-2x)^2/3-(-2(x+1)^2)/4-7/2=0" },
      ],
    },
    {
      id: "quad-mixed-7",
      ...
      exercises: [
        ...
        { n: 21, start: "x-10/x=3" },
        { n: 22, start: "x-3=4/x" },
        { n: 23, start: "4/x-4+x=0" },
        { n: 24, start: "2/(x-1)=x" },
        { n: 25, start: "18/(x-5)=-3x" },
        { n: 26, start: "x-6/(x-2)=3" },
        { n: 27, start: "x/3=12/x" },
        { n: 28, start: "(x-2)/3=1/x" },
        { n: 29, start: "x/9=3/(2x+3)" },
        { n: 30, start: "4/x+7/(x+3)=2" },
        { n: 31, start: "10/(x-7)-9/x=4" },
        { n: 32, start: "3/(4+x)=x/(x+2)" },
        { n: 33, start: "1/(x-1)=x/(3+x)" },
        { n: 34, start: "(x-10)/(x-2)=(x-1)/(x-5)" },
        { n: 35, start: "(2x-1)/(2x+4)=(x-1)/(x+1)" },
        { n: 36, start: "(3x-4)/(3x+2)=(x-1)/(x+2)" },
        { n: 37, start: "(3x-2)/(x+4)+5/(4-2x)=0" },
        { n: 38, start: "(2x+1)/(x-1)+10/(3x-4)=0" },
        { n: 39, start: "(2x+6)/(x-3)+1/(2x+3)=0" },
        { n: 40, start: "(x+4)/(x-2)-(x+3)/x=5" },
      ],
    },
    {
      id: "high-factor-1",
    ...
    },
    {
      ...
      exercises: [
        { n: 10, start: "x^3-4x^2=0" },
        { n: 11, start: "x^3+8x^2=0" },
        { n: 12, start: "x^3-x^2=0" },
        { n: 13, start: "4x^3-8x^2=0" },
        { n: 14, start: "3x^3=15x^2" },
        { n: 15, start: "6x^3=x^2" },
        { n: 16, start: "x^4-x^3=0" },
        { n: 17, start: "4x^4=8x^3" },
        { n: 18, start: "7x^4-21x^3=0" },
        { n: 19, start: "5x^4-20x^3=0" },
        { n: 20, start: "x^4-x^2=0" },
        { n: 21, start: "x^4-4x^2=0" },
        { n: 22, start: "3x^4-108x^2=0" },
        { n: 23, start: "5x^4=125x^2" },
        { n: 24, start: "3x^5-48x^3=0" },
      ],
    },
    {
      id: "high-root-3",
      ...
      exercises: [
        ...
        { n: 37, start: "x^6=64" },
        { n: 38, start: "x^3-64=0" },
        { n: 39, start: "x^4-625=0" },
        { n: 40, start: "x^5-32=0" },
        { n: 41, start: "x^3+125=0" },
        { n: 42, start: "x^4+16=0" },
        { n: 43, start: "x^5=0" },
      ],
    },
    {
      ...
      exercises: [
        { n: 1, eq1: "x+3y=36", eq2: "x=6" },
        { n: 2, eq1: "3x-7y=4", eq2: "y-2=0" },
        { n: 3, eq1: "5x+3y=36", eq2: "x=y+4" },
        { n: 4, eq1: "8x+5y=21", eq2: "y+3=2x" },
        { n: 5, eq1: "5x+4y=18", eq2: "x+3y=8" },
        { n: 6, eq1: "-x-y=12", eq2: "5x-6y=-5" },
        { n: 7, eq1: "y=x+5", eq2: "y=2x+4" },
        { n: 8, eq1: "y=-4x+40", eq2: "y=3x+5" },
        { n: 9, eq1: "4y=3x-4", eq2: "4y=5x-12" },
        { n: 10, eq1: "5x+4y=36", eq2: "8x-7y=4" },
        { n: 11, eq1: "7x+6y=72", eq2: "5x+4y=50" },
        { n: 12, eq1: "-3x+5y=3", eq2: "7x-4y=16" },
        { n: 13, eq1: "7x+3y=20", eq2: "5x=2y+6" },
        { n: 14, eq1: "4x-2y=1", eq2: "y=2x+5" },
        { n: 15, eq1: "x+3y=10", eq2: "2x+6y=20" },
      ],
    },
    {
      id: "geo-segments-1",
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          tasks: [
            { id: "mAB", label: "m", kind: "slope", from: "A", to: "B" },
            { id: "mDC", kind: "slope", parallel: true, m: 1 / 3, mn: 1, md: 3, label: "DC", givenLabel: "AB", from: "D", to: "C" },
            {
              id: "mBC",
              label: "BC",
              kind: "slope",
